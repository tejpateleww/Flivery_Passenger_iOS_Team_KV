...
//        UIAlertController()
    ...
    @IBOutlet weak var txtTransportService: IQDropDownTextField!
...
//        openRatingView()
    ...
    {
        if textField == self.txtTransportService
        {
...
//
        ...
        self.txtTransportService.delegate = self
        self.btnDoneForLocationSelected.isHidden = true
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.setNavBarWithMenuORBack(Title: "Home".localized, LetfBtn: kIconMenu, IsNeedRightButton: false, isTranslucent: false)
...
//                }
                ...
                next.strEstimatedFare = strEstimatedTotal
        ...
        viewTransportService.layer.borderWidth = 1.0
        viewTransportService.layer.borderColor = UIColor.gray.cgColor
        
        viewTransportService.layer.cornerRadius = 5
        viewTransportService.layer.masksToBounds = true
...
//                self.btnDoneForLocationSelected.isHidden = true
    ...
    func webserviceCallForBookingCar()
    {
        ...
        dictParams.setObject(self.strSelectedParcelID, forKey: SubmitBookingRequest.kParcelID as NSCopying)
        ...
        dictParams.setObject(self.strSelectedParcelID, forKey: "ParcelId" as NSCopying)
        dictParams.setObject("delivery", forKey: "RequestFor" as NSCopying)
...
//                                (UIApplication.shared.delegate as! AppDelegate).window?.rootViewController?.present(alert, animated: true, completion: nil)
                    ...
                    if let IndexforSelectedVehicle =  self.selectedIndexPath {
...
//            if dictOnlineCarData["carCount"] as! Int != 0 {
                ...
                if self.aryEstimateFareData.count != 0 {
                    ...
                    if ((self.aryEstimateFareData.object(at: indexPath.row) as! NSDictionary).object(forKey: "total") as? NSNull) != nil {
                        ...
                        cell.lblPrices.text = "\(currencySign) \(EstimateFare)"
                    }
                }
//            }
        }
        ...
        else if (arrNumberOfOnlineCars.count != 0 && indexPath.row < self.arrNumberOfOnlineCars.count)
        {
            ...
            if dictOnlineCarData.object(forKey: "carCount") as! Int != 0 {
                ...
                if (self.aryEstimateFareData.count != 0 )
                {
                    ...
                    {
//                        if let tempTotal = tempDictEstimateFare["total"] as? String
//                        {
//                            self.strSelectedCarTotalFare = tempTotal
//                        }
//                        else if let tempTotal = tempDictEstimateFare["total"] as? Int
//                        {
//                            self.strSelectedCarTotalFare = "\(tempTotal)"
//                        }
//                        else if let tempTotal = tempDictEstimateFare["total"] as? CGFloat
//                        {
//                            self.strSelectedCarTotalFare = "\(tempTotal)"
//                        }
                ...
                if ((self.aryEstimateFareData.object(at: indexPath.row) as! NSDictionary).object(forKey: "total") as? NSNull) != nil {
                    ...
                    strEstimatedTotal = "\(currencySign) \(0)"
                }
                else if let price = (self.aryEstimateFareData.object(at: indexPath.row) as! NSDictionary).object(forKey: "total") as? Double {
//                    EstimateFare = "\(price)"
                    EstimateFare = "\(String(format : "%.2f", price))"
                    strEstimatedTotal = "\(currencySign) \(EstimateFare)"
                }
            ...
            for i in 0..<self.aryTempOnlineCars.count {
                ...
                if (self.checkTempData.object(at: i) as! NSDictionary) == arySwif {
                    ...
                    if SingletonClass.sharedInstance.isFirstTimeReloadCarList == true {
                        ...
                        // && self.aryOfOnlineCarsIds.count != 0
                        if self.txtCurrentLocation.text!.trimmingCharacters(in: .whitespacesAndNewlines).count != 0 && self.txtDestinationLocation.text!.trimmingCharacters(in: .whitespacesAndNewlines).count != 0{
                            self.postPickupAndDropLocationForEstimateFare()
                        }
                        self.collectionViewCars.reloadData()
...
//                        }
    ...
    func DriverInfoAndSetToMap(driverData: NSArray) {
        ...
        _ = (((self.aryRequestAcceptedData as NSArray).object(at: 0) as! NSDictionary).object(forKey: "BookingInfo") as! NSArray).object(at: 0) as! NSDictionary
...
//&& aryOfOnlineCarsIds.count != 0
        if txtCurrentLocation.text!.trimmingCharacters(in: .whitespacesAndNewlines).count != 0 && txtDestinationLocation.text!.trimmingCharacters(in: .whitespacesAndNewlines).count != 0  {
            postPickupAndDropLocationForEstimateFare()
        }
